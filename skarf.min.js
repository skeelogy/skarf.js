...
SKARF.ObjModelLoader.prototype.loadForMarker=function(a,b,c,d,f,e){this.model=a;this.__markerId=b;this.__markerTransform=c;this.overallScale=d;this.isWireframeVisible=f;this.markerManager=e;b=a.url.replace(/\.obj/g,".mtl");this.loader.load(a.url,b)};SKARF.MarkerManager=function(a){this.markersJsonFile=a;this.markerData=null;this.modelLoaders={};this.materials=[];this.__load()};
